...
import com.jlu.madizm.leguang.widget.RecycleBin;
 ...
 * view recycling.
 */
public abstract class AdapterRecyclingPager extends PagerAdapter {
  static final int IGNORE_ITEM_VIEW_TYPE = AdapterView.ITEM_VIEW_TYPE_IGNORE;

  private final RecycleBin recycleBin;

  public AdapterRecyclingPager() {
    this(new RecycleBin());
  }

  AdapterRecyclingPager(RecycleBin recycleBin) {
