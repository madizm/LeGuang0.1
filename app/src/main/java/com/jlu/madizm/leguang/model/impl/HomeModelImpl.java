package com.jlu.madizm.leguang.model.impl;
...
import com.jlu.madizm.leguang.okhttp.OkCallback;
import com.jlu.madizm.leguang.okhttp.OkHttp;
import com.jlu.madizm.leguang.presenter.OnLoadListener;
import com.jlu.madizm.leguang.utils.NetWorkUtil;
...
public class HomeModelImpl implements HomeLoadModel {
    ...
    public void load(final OnLoadListener<HomeTop> listener, Context context, int type) {
        //这里不调接口，直接返回
        if (type == 1) {
            listener.onSuccess(getTop());//使用模拟数据
            return;
        }
    ...
    private HomeTop getTop() {
        ...
        carouselList.add(new HomeTop.Carousel(1, "http://wx3.sinaimg.cn/mw690/006304mUly1fl2w5gv4nmj30ri0a015k.jpg"));
        carouselList.add(new HomeTop.Carousel(2, "http://wx1.sinaimg.cn/mw690/006304mUly1fl2w5h6kf7j30ri0a0mzk.jpg"));
        carouselList.add(new HomeTop.Carousel(3, "http://wx2.sinaimg.cn/mw690/006304mUly1fl2w5hgx33j30kh077413.jpg"));
        ...
        //list添加头部
        list.add(new HomeBase(0, 0, "", "吉大巨幕", HomeBase.TYPE_HEADER, spanCount));

        list.add(new HomeBase(11, 0, "http://wx3.sinaimg.cn/mw690/006304mUgy1fl2wdogrmnj30j307s0uy.jpg", "别out了", HomeBase.TYPE_LIVE, spanCount));

        list.add(new HomeBase(0, 0, "", "", HomeBase.TYPE_DIVIDER, spanCount));


        list.add(new HomeBase(12, 0, "http://wx1.sinaimg.cn/mw690/006304mUgy1fl2weto0uqj30jb0blt8x.jpg", "运动健身", HomeBase.TYPE_HOT, spanCount/2));
        list.add(new HomeBase(12, 0, "http://wx3.sinaimg.cn/mw690/006304mUgy1fl2weu7o44j30m80m8gqb.jpg", "游泳塑形", HomeBase.TYPE_HOT, spanCount/2));

        list.add(new HomeBase(12, 0, "http://wx2.sinaimg.cn/mw690/006304mUgy1fl2wetb8vtj306g06gq35.jpg", "xx", HomeBase.TYPE_HOT, spanCount/3));
        list.add(new HomeBase(12, 0, "http://wx1.sinaimg.cn/mw690/006304mUgy1fl2wethd8bj306g06gjrq.jpg", "xx", HomeBase.TYPE_HOT, spanCount/3));
        list.add(new HomeBase(12, 0, "http://wx1.sinaimg.cn/mw690/006304mUgy1fl2wetx9fwj30b40b474g.jpg", "xx", HomeBase.TYPE_HOT, spanCount/3));
